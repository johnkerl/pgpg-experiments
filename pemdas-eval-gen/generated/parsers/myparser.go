...
var MyParserActions = map[int]map[tokens.TokenType]MyParserAction{
	0: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 10},
		tokens.TokenType("lparen"):      {Kind: MyParserActionShift, Target: 11},
		tokens.TokenType("minus"):       {Kind: MyParserActionShift, Target: 12},
	...
	2: {
		...
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 13},
	},
	3: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 16},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 17},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 18},
	},
	4: {
		tokens.TokenTypeEOF:                {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("exponentiation"): {Kind: MyParserActionShift, Target: 19},
		tokens.TokenType("minus"):          {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 16},
	},
	5: {
		tokens.TokenTypeEOF:                {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("exponentiation"): {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("minus"):          {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 18},
	...
	9: {
		...
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 10},
	},
	10: {
		tokens.TokenTypeEOF:                {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("exponentiation"): {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("minus"):          {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 19},
	},
	11: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 27},
		tokens.TokenType("lparen"):      {Kind: MyParserActionShift, Target: 28},
		tokens.TokenType("minus"):       {Kind: MyParserActionShift, Target: 29},
		tokens.TokenType("plus"):        {Kind: MyParserActionShift, Target: 30},
	},
	12: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 10},
		tokens.TokenType("lparen"):      {Kind: MyParserActionShift, Target: 11},
	...
	21: {
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 13},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 13},
	},
	22: {
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 42},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 43},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 6},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 44},
	},
	23: {
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("exponentiation"): {Kind: MyParserActionShift, Target: 45},
		tokens.TokenType("minus"):          {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("rparen"):         {Kind: MyParserActionReduce, Target: 16},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 16},
	},
	24: {
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 18},
		...
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("rparen"):         {Kind: MyParserActionReduce, Target: 18},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 18},
	},
	25: {
		tokens.TokenType("rparen"): {Kind: MyParserActionShift, Target: 46},
	},
	26: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 10},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 10},
	},
	27: {
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 19},
		...
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("rparen"):         {Kind: MyParserActionReduce, Target: 19},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 19},
	},
	28: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 27},
	...
	31: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 12},
	},
	32: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 11},
	},
	33: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 16},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 17},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 18},
	},
	34: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 4},
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 16},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 4},
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 17},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 4},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 18},
	},
	35: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 8},
	},
	36: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 9},
	},
	37: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 7},
	},
	38: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 14},
	},
	39: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 10},
		tokens.TokenType("lparen"):      {Kind: MyParserActionShift, Target: 11},
	...
	45: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 27},
		tokens.TokenType("lparen"):      {Kind: MyParserActionShift, Target: 28},
		tokens.TokenType("minus"):       {Kind: MyParserActionShift, Target: 57},
	},
	46: {
		tokens.TokenTypeEOF:                {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("divide"):         {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("exponentiation"): {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("minus"):          {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 17},
	},
	47: {
		tokens.TokenType("rparen"): {Kind: MyParserActionShift, Target: 58},
	},
	48: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 12},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 12},
	},
	49: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 11},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 11},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 11},
	},
	50: {
		tokens.TokenTypeEOF:        {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 15},
	},
	51: {
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 42},
		tokens.TokenType("minus"):  {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 43},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 5},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 44},
	},
	52: {
		tokens.TokenType("divide"): {Kind: MyParserActionShift, Target: 42},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionShift, Target: 43},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 4},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 4},
		tokens.TokenType("times"):  {Kind: MyParserActionShift, Target: 44},
	},
	53: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 8},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 8},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 8},
	},
	54: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 9},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 9},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 9},
	},
	55: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 7},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 7},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 7},
	},
	56: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 14},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 14},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 14},
	},
	57: {
		tokens.TokenType("int_literal"): {Kind: MyParserActionShift, Target: 27},
	...
	58: {
		...
		tokens.TokenType("modulo"):         {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("plus"):           {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("rparen"):         {Kind: MyParserActionReduce, Target: 17},
		tokens.TokenType("times"):          {Kind: MyParserActionReduce, Target: 17},
	},
	59: {
		tokens.TokenType("divide"): {Kind: MyParserActionReduce, Target: 15},
		...
		tokens.TokenType("modulo"): {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("plus"):   {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("rparen"): {Kind: MyParserActionReduce, Target: 15},
		tokens.TokenType("times"):  {Kind: MyParserActionReduce, Target: 15},
	},
}
