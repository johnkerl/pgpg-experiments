...
var MyParserActions = map[int]map[tokens.TokenType]MyParserAction{
	...
	1: {
		tokens.TokenType(","):          {Kind: MyParserActionAcceptAndYield},
		tokens.TokenType(";"):          {Kind: MyParserActionAcceptAndYield},
		tokens.TokenType("="):          {Kind: MyParserActionAcceptAndYield},
		tokens.TokenTypeEOF:            {Kind: MyParserActionAccept},
		tokens.TokenType("const"):      {Kind: MyParserActionAcceptAndYield},
		tokens.TokenType("constant"):   {Kind: MyParserActionAcceptAndYield},
		tokens.TokenType("identifier"): {Kind: MyParserActionAcceptAndYield},
		tokens.TokenType("program"):    {Kind: MyParserActionAcceptAndYield},
	},
	2: {
